...
def train(text_encoder, image_encoder, optimizer, dataloader, logger, scaler, args, epoch):
    ...
    for i, (train_inputs, train_labels) in enumerate(dataloader):
        ...
        with autocast(enabled=True):
            ...
            train_labels = train_labels.to("mps")
...
def test(text_encoder, image_encoder, args, dataloader, logger, len_testdataset):
    ...
    for features, labels_1006, labels_81, _ in dataloader:
        ...
        with autocast():
            ...
            pred_feat, dist_feat = image_encoder.encode_img(features.to("mps"))
    ...
    if is_main_process():
        ...
        ap_81 = compute_AP(prediction_81.to("mps"), lab_81.to("mps"))
        F1_3_81,P_3_81,R_3_81 = compute_F1(prediction_81.to("mps"), lab_81.to("mps"), 'overall', k_val=3)
        F1_5_81,P_5_81,R_5_81 = compute_F1(logits_81_5.to("mps"), lab_81.to("mps"), 'overall', k_val=5)
        ...
        ap_1006 = compute_AP(prediction_1006.to("mps"), lab_1006.to("mps"))
        F1_3_1006,P_3_1006,R_3_1006 = compute_F1(prediction_1006.to("mps"), lab_1006.to("mps"), 'overall', k_val=3)
        F1_5_1006,P_5_1006,R_5_1006 = compute_F1(logits_1006_5.to("mps"), lab_1006.to("mps"), 'overall', k_val=5)
